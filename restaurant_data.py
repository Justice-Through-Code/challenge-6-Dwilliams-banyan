...
def favorite_restaurant():
    ...
    #    }
    favorite_restaurant["name"] = input('Hey, what is the name your of favorite restaurant? ')
    favorite_restaurant["address"] = input('Hey, what is the address of your favorite restaurant? ')
    favorite_restaurant["favorite_dish"] = input(f'Hey, what is your favorite dish to order from {favorite_restaurant["name"]}? ')
...
def clean_print():
    ...
    #       url: https://www.yelp.com/biz/four-barrel-coffee-san-francisco`
    # etc etc
    for keys in restaurant_1:
        print(f'{keys}: {restaurant_1[keys]}')
